...
@fact typeof(feature) --> GeoInterface.Feature{UTF8String}
@fact GeoInterface.geometry(feature) --> nothing
@fact GeoInterface.properties(feature) --> feature.properties
@fact typeof(feature.properties) --> Dict{UTF8String,Any}
...
@fact GeoInterface.crs(feature) --> feature.properties["crs"]
@fact typeof(GeoInterface.crs(feature)) --> Dict{UTF8String,Any}
...
@fact map(typeof,buildings.features) --> fill(GeoInterface.Feature{UTF8String},4)
...
@fact typeof(building_dict) --> Dict{ASCIIString,Any}
